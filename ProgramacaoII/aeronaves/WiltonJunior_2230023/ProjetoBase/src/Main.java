...
public class Main {
    public static void main(String[] args) {
        ...
        AviaoMilitar aviaoMilitar = new AviaoMilitar();
        aviaoMilitar.abastecer(5000);
        aviaoMilitar.adicionar(militar1);
        aviaoMilitar.adicionar(militar2);
        aviaoMilitar.voarDiagonal(500, 1500);
        aviaoMilitar.voarDiagonal(500, 1500);
        System.out.println(aviaoMilitar);
