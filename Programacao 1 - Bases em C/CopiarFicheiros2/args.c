...
const char *gengetopt_args_info_help[] = {
  ...
  "  -o, --outfile=dirname   outfile",
  "  -b, --buffsize=INT      buffer",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->buffsize_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->buffsize_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->buffsize_given)
    write_into_file(outfile, "buffsize", args_info->buffsize_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVf:o:b:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* buffer.  */
          ...
          if (update_arg( (void *)&(args_info->buffsize_arg), 
               &(args_info->buffsize_orig), &(args_info->buffsize_given),
              &(local_args_info.buffsize_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "buffsize", 'b',
              additional_error))
            goto failure;
