...
struct gengetopt_args_info
{
  ...
  int buffsize_arg;	/**< @brief buffer.  */
  char * buffsize_orig;	/**< @brief buffer original value given at command line.  */
  const char *buffsize_help; /**< @brief buffer help description.  */
  ...
  unsigned int buffsize_given ;	/**< @brief Whether buffsize was given.  */
