...
const char *gengetopt_args_info_purpose = "Binary file converter.";

const char *gengetopt_args_info_usage = "Usage: bin2text [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Author – 2230922 / Simao Curado\n\nOperating Systems - ESTG - Leiria";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --type=string   Type of data (I=integer; L=long)",
  "  -s, --show=integer  Display more info (0=disable; 1=enable)",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->show_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->show_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->show_given)
    write_into_file(outfile, "show", args_info->show_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->in_given)
    {
      fprintf (stderr, "%s: '--in' ('-i') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  if (! args_info->type_given)
    {
      fprintf (stderr, "%s: '--type' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:t:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'o':	/* Output file name.  */
          ...
          break;
        case 't':	/* Type of data (I=integer; L=long).  */
          ...
          break;
        case 's':	/* Display more info (0=disable; 1=enable).  */
        
        
          if (update_arg( (void *)&(args_info->show_arg), 
               &(args_info->show_orig), &(args_info->show_given),
              &(local_args_info.show_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "show", 's',
              additional_error))
            goto failure;
